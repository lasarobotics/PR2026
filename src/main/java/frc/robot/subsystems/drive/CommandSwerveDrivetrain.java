...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
  ...
  public void resetPose() {
    ...
    if (DriverStation.getAlliance().orElse(DriverStation.Alliance.Blue)
      ...
      this.resetPose(
          new Pose2d(current_pose.getX(), current_pose.getY(), kRedAlliancePerspectiveRotation));
    else
      this.resetPose(
          new Pose2d(current_pose.getX(), current_pose.getY(), kBlueAlliancePerspectiveRotation));
  }
